...
export var Input = function (_a) {
    var customInput = _a.customInput, id = _a.id, label = _a.label, labelSuffix = _a.labelSuffix, fieldSize = _a.fieldSize, isLabelUppercase = _a.isLabelUppercase, isError = _a.isError, isPassword = _a.isPassword, rightElement = _a.rightElement, leftElement = _a.leftElement, note = _a.note, error = _a.error, success = _a.success, copyButton = _a.copyButton, infoText = _a.infoText, infoLink = _a.infoLink, props = __rest(_a, ["customInput", "id", "label", "labelSuffix", "fieldSize", "isLabelUppercase", "isError", "isPassword", "rightElement", "leftElement", "note", "error", "success", "copyButton", "infoText", "infoLink"]);
    var _b = useState(true), isPasswordMasked = _b[0], setIsPasswordMasked = _b[1];
