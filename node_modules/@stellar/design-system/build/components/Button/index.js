...
export var Button = function (_a) {
    var variant = _a.variant, size = _a.size, children = _a.children, icon = _a.icon, _b = _a.iconPosition, iconPosition = _b === void 0 ? "right" : _b, isLoading = _a.isLoading, isFullWidth = _a.isFullWidth, _c = _a.showActionTooltip, showActionTooltip = _c === void 0 ? false : _c, _d = _a.actionTooltipText, actionTooltipText = _d === void 0 ? "Done" : _d, _e = _a.actionTooltipPlacement, actionTooltipPlacement = _e === void 0 ? "bottom" : _e, props = __rest(_a, ["variant", "size", "children", "icon", "iconPosition", "isLoading", "isFullWidth", "showActionTooltip", "actionTooltipText", "actionTooltipPlacement"]);
    ...
    var additionalClasses = __spreadArray([
        ...
        "Button--".concat(size)
    ], (isFullWidth ? ["Button--full-width"] : []), true).join(" ");
