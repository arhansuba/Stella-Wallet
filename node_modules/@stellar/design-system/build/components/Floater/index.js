...
export var Floater = function (_a) {
    ...
    return (_jsxs("div", { className: "Floater", ref: parentRef, children: [_jsx(_Fragment, { children: isStatic
                    ...
                    }) }), _jsxs("div", { ref: floaterRef, className: "Floater__content ".concat(additionalClasses), children: [children, showArrow ? (_jsx("div", { className: "Floater__arrow", ref: floaterArrowRef, children: _jsx(ArrowIcon, {}) })) : null] })] }));
};
