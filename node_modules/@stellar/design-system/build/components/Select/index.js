...
export var Select = function (_a) {
    var id = _a.id, fieldSize = _a.fieldSize, children = _a.children, label = _a.label, labelSuffix = _a.labelSuffix, note = _a.note, error = _a.error, success = _a.success, infoText = _a.infoText, infoLink = _a.infoLink, isLabelUppercase = _a.isLabelUppercase, isError = _a.isError, customSelect = _a.customSelect, props = __rest(_a, ["id", "fieldSize", "children", "label", "labelSuffix", "note", "error", "success", "infoText", "infoLink", "isLabelUppercase", "isError", "customSelect"]);
