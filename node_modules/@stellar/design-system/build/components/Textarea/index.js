...
export var Textarea = function (_a) {
    var id = _a.id, fieldSize = _a.fieldSize, _b = _a.children, children = _b === void 0 ? "" : _b, label = _a.label, labelSuffix = _a.labelSuffix, note = _a.note, error = _a.error, success = _a.success, infoText = _a.infoText, infoLink = _a.infoLink, isError = _a.isError, isLabelUppercase = _a.isLabelUppercase, hasCopyButton = _a.hasCopyButton, customTextarea = _a.customTextarea, _c = _a.spellCheck, spellCheck = _c === void 0 ? false : _c, _d = _a.autoComplete, autoComplete = _d === void 0 ? "off" : _d, props = __rest(_a, ["id", "fieldSize", "children", "label", "labelSuffix", "note", "error", "success", "infoText", "infoLink", "isError", "isLabelUppercase", "hasCopyButton", "customTextarea", "spellCheck", "autoComplete"]);
